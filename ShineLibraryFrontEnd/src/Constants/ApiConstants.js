...
// Quote reated api call

export const QUOTE_API_URL = "https://api.quotable.io/quotes?page=1";
// export const RNDM_QUOTE_API_URL = "https://api.quotable.io/quotes/random";